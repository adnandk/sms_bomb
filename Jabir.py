...
logo =                                          ("""   
  ___  ______  _   _ ______  _   _  _      _       ___   _   _ 
 / _ \ | ___ \| | | ||  _  \| | | || |    | |     / _ \ | | | |
/ /_\ \| |_/ /| | | || | | || | | || |    | |    / /_\ \| |_| |
|  _  || ___ \| | | || | | || | | || |    | |    |  _  ||  _  |
| | | || |_/ /| |_| || |/ / | |_| || |____| |____| | | || | | |
\_| |_/\____/  \___/ |___/   \___/ \_____/\_____/\_| |_/\_| |_/
...
\033[1;32m[-] AUTHOR    :\033[1;32m Abdullah Ibrahim  
\033[1;32m[-] GITHUB    :\033[1;32m BOLD OUT
\033[1;32m[-] FACEBOOK  :\033[1;32m Abdullah Ibrahim 
...
rp= 'HeacK Me'
x = 'HeacK Me'
if 'HeacK Me'==user and 'HeacK Me'==pas:
	Axak(g+"\n\n\t\t      LOGIN SUCCESSFUL JOIN MY FACEBOOK GROUP ")
	os.system('xdg-open https://www.facebook.com/abdullah.vhai22.58')
else:
	Axak(y+"\n\n\t\t      Invalid User Or Pass")
	Axak(y+"\n\n\t\tContract Admin For User And Pass")
	os.system("xdg-open https://wa.me/+8801609657136")
...
number=input(f"{c}\n[ VICTIM NUMBER ] :{w} +880")
amo=int(input(c+"\n[ AMOUNT ] : "+w))
xak(f"\n\n\t {w}<{r}/{w}> {g}STAY WITH Jabir Adnan  ;) {w}<{r}/{w}>\n\n")
...
for i in range(amo):
	...
	print(f"\n\t\t {ran2}SMS SENT SUCCESFULLY💚  BY 🔥Abdullah Ibrahim🔥 "+w+tim)
	...
	print(f"\n\t\t {ran2}SMS SENT SUCCESFULLY💚  BY 🔥Jabir Adnan🔥 "+w+tim)
